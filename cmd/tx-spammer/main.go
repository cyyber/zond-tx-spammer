...
func main() {
	...
	flags.StringVarP(&cliArgs.walletSeed, "wallet-seed", "w", "", "The seed of the wallet to send funds from.")
	flags.StringVarP(&cliArgs.childWalletSeed, "child-wallet-seed", "c", "", "The child wallet seed.")
